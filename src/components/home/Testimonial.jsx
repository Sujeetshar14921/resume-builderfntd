    ...
    <section className="py-24 px-6 bg-slate-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl font-bold mt-4 text-slate-900">Loved by Job Seekers</h2>

          <p className="text-slate-500 mt-4 max-w-2xl mx-auto">
            Thousands of professionals use our platform to build resumes and land better opportunities.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {testimonials.map((item, index) => (
            <div
              key={index}
              className="bg-white rounded-3xl p-8 border border-slate-200 hover:shadow-xl transition-all"
            >
